            ...
            >
              <Col sm={12} md={2}>
                <div className="how-it-works-logo-grey">
                  <center>
                    <i
                      className="fa fa-users blue-color"
              ...
              <Col sm={12} md={10}>
                <Row sm={12} md={12}>
                  <h3 className="blue-color" style={{ textAlign: 'center', fontWeight: 500 }}>
                    This will let your lanloard know others support recycling in your building, too!
                    You are not alone! Signing will also show your lanloard people pledge to use
                    recycling services correctly.
                  </h3>
                </Row>
                <Row sm={12} md={12}>
                  <Col sm={12} md={5}>
